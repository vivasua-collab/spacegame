...
**Этап 2, 2.5, 2.6, 3.0 завершены.** Работающий MVP: генерация галактики, колонизация, добыча ресурсов, крафт, флот, исследования, сохранение/загрузка. Все 340 тестов проходят, 75/75 рецептов валидны, lint: 0 errors / 50 warnings.

**Следующий этап — 3.5 (AI-фракции).** Спецификация в [`docs/70-ai.md`](./docs/70-ai.md). Полная информация в [`docs/STATUS.md`](./docs/STATUS.md) и [`checkpoints/audit_2026_08_27_0{1,2,3,4}_*.md`](./checkpoints/) (Pass 1/2/3/4 аудита 2026-08-27).
...
├── checkpoints/                # Чекпоинты разработки (30 файлов)
│   ├── RULES.md                # Правила чекпоинтов
│   ├── ROADMAP.md              # Глобальная дорожная карта
│   ├── audit_2026_08_27_0{1,2,3,4}_*.md # Аудиты Pass 1/2/3/4
...
| `src/data/` | Справочные данные: 60 элементов (57 base + 3 transuranic), 15 зданий, ~75 рецептов. | ✅ MVP завершён |
...
| [`60-research.md`](./docs/60-research.md) | Исследования: спецификация (✅ Block 03 завершён — 15/72 techs) |
| [`70-ai.md`](./docs/70-ai.md) | AI: спецификация (не реализовано, Etap 3.5) |
