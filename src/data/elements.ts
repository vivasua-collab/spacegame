/**
 * Определения элементов — 60 элементов (57 базовых + 3 трансурановых Np/Pu/Am из Block 01 P7) для SpaceGame.
 * Расширенная таблица (версия 4.0) на основе docs/32-mendeleev.md.
 *
 * Категории:
