...
export const DEEP_ORES: OreDefinition[] = [
  ...
  },
  {
    ...
    sourceBuildingId: 'drilling_rig',
    containedElements: [
      { elementId: 'Be', yield: 1.0 },
      { elementId: 'Al', yield: 2.0 },
      { elementId: 'Si', yield: 3.5 },
