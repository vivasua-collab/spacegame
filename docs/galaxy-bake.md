...
| Руды | Автогенерация по 33-chemistry.md | Полный набор руд с рассчитанными выходами |
| Атмосферные соединения | Правила из 33-chemistry.md §9 | Набор газов с рассчитанным составом |
| Ледяные соединения | Правила из 33-chemistry.md §9 | Набор льдов с рассчитанным составом |
| Цепочки переработки | На основе руд | Маппинг «элемент → руда → переработка» |
| Самородные элементы | Правила из 33-chemistry.md §8 | Шансы самородков |
...
1. Определить тип руды и здание добычи по 33-chemistry.md §5
2. Выбрать формулу минерала-прототипа по 33-chemistry.md §4
3. Рассчитать молярную массу: `M = Σ(nᵢ × Mᵢ)`
4. Рассчитать выход: `outputᵢ = 10 × (nᵢ × Mᵢ) / M`
5. Назначить переработку по 33-chemistry.md §6
6. Рассчитать энергозатраты по 33-chemistry.md §7
7. Определить самородный шанс по 33-chemistry.md §8
