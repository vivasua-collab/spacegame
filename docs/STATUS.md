...
> Дата: 2026-06 (после аудита) · Изменён: 2026-08-31 (docs-sync: R-STARS-DATA / R-23 / R-24 + переименование чекпоинтов под `checkpoints/RULES.md`)
...
| Работает ли MVP | ✅ Да (генерация, колонизация, типовая синергия застройки, снос/понижение уровней, добыча, крафт, флот, исследования R-SPLIT, сохранение) |
...
| Руд (в коде) | 56 |
| Зданий (data-driven JSON / по spec) | 17 / 27 (63%) + 4 правила синергии (synergy.json) |
...
| 🟢 NEXT-2 | Возврат кросс-типовых правил синергии (mine_processor, warehouse_production — одна запись в synergy.json, §5.5) | ~1 ч | Геймплей |
