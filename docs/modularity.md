...
*Документ обновлён 2026-05-04 (v2.0). Интегрирован с [chemistry.md](./chemistry.md). Согласовано с `src/data/elements.ts` (58 элементов), `src/data/processing-chains.ts` (33+18+3 руды, 11 газов, 5 льдов).*
