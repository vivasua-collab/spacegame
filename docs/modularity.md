...
> **Зависимости:** [33-chemistry.md](./33-chemistry.md) (правила химических взаимодействий), [32-mendeleev.md](./32-mendeleev.md) (химическая таблица элементов), [34-ores.md](./34-ores.md) (расчёты руд)
...
| [32-mendeleev.md](./32-mendeleev.md) | Список элементов, атомные массы, химические характеры — входные данные |
